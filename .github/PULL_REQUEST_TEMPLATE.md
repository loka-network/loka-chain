...
- [ ] targeted the correct branch
      (see [PR Targeting](https://github.com/loka-network/loka-chain/blob/main/CONTRIBUTING.md#pr-targeting))
...
- [ ] written unit and integration [tests](https://github.com/loka-network/loka-chain/blob/main/CONTRIBUTING.md#testing)
