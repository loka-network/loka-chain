...
func EthSetup(isCheckTx bool, patchGenesis func(*Evmos, GenesisState) GenesisState) *Evmos {
...
func EthSetupWithDB(isCheckTx bool, patchGenesis func(*Evmos, GenesisState) GenesisState, db dbm.DB) *Evmos {
