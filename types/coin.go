...
// NewEvmosCoin is a utility function that returns an "ahetu" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewEvmosCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoEvmos, amount)
}

// NewEvmosDecCoin is a utility function that returns an "ahetu" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewEvmosDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoEvmos, amount)
}

// NewEvmosCoinInt64 is a utility function that returns an "ahetu" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
