...
import (
	...
	"github.com/loka-network/loka/v1/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "aloka"),
...
func (k Keeper) OnRecvPacket(
	...
	// Get addresses in `loka1` and the original bech32 format
