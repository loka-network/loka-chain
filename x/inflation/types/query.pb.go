...
type QueryEpochMintProvisionResponse struct {
	...
	EpochMintProvision types.DecCoin `protobuf:"bytes,1,opt,name=epoch_mint_provision,json=epochMintProvision,proto3,castrepeated=cosmossdk.io/math.LegacyDecCoins" json:"epoch_mint_provision"`
}
...
type QueryCirculatingSupplyResponse struct {
	...
	CirculatingSupply types.DecCoin `protobuf:"bytes,1,opt,name=circulating_supply,json=circulatingSupply,proto3,castrepeated=cosmossdk.io/math.LegacyDecCoins" json:"circulating_supply"`
}
...
var fileDescriptor_91b9f1b5d47c7fd7 = []byte{
	...
	,
}
